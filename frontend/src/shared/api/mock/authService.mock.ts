import type { TokenRequest, TokenResponse, TokenInfo } from '@/shared/types/openapi.types';
...
export const authServiceMock = {
  async login(username: string, password: string): Promise<{ token: string; user: typeof mockUser }> {
