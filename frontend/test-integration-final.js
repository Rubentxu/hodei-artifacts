...
/**
 * Script de prueba de integración final para verificar que la aplicación frontend
...
async function testApplication() {
  ...
  try {
    ...
    const statsText = await page.evaluate(() => {
      const texts = ['Repositories', 'Packages', 'Users', 'Downloads'];
    ...
    await delay(1000); // Usar delay en lugar de waitForTimeout
