//! Dependency Injection helpers for `create_policy_new` feature
//!
...
//! -------------
//! ```rust,ignore
//! use hodei_iam::features::create_policy_new::di;
//! use hodei_iam::features::create_policy_new::mocks::MockPolicyValidator;
//! use std::sync::Arc;
//!
//! # async fn example() {
//! let validator = Arc::new(MockPolicyValidator::new());
//! let use_case = di::in_memory_use_case("acct-123", validator);
//! let cmd = hodei_iam::features::create_policy_new::CreatePolicyCommand {
//!     policy_id: "p1".into(),
...
use crate::features::create_policy_new::adapter::InMemoryCreatePolicyAdapter;
