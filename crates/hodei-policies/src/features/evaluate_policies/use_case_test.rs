hodei-artifacts/crates/hodei-policies/src/features/evaluate_policies/use_case_test.rs
//! Comprehensive unit tests for the evaluate_policies use case
//!
//! These tests provide extensive coverage of policy evaluation scenarios,
//! including various policy types, entity configurations, context handling,
//! and error conditions to achieve >80% test coverage.
...
impl HodeiEntityType for MockUser {
    ...
    fn attributes_schema() -> Vec<(kernel::domain::AttributeName, kernel::domain::AttributeType)> {
        vec![
            (kernel::domain::AttributeName::new("name").unwrap(), kernel::domain::AttributeType::string()),
            (kernel::domain::AttributeName::new("active").unwrap(), kernel::domain::AttributeType::bool()),
            (kernel::domain::AttributeName::new("role").unwrap(), kernel::domain::AttributeType::string()),
            (kernel::domain::AttributeName::new("department").unwrap(), kernel::domain::AttributeType::string()),
        ]
    }
}
...
impl HodeiEntity for MockUser {
    ...
    fn attributes(&self) -> HashMap<kernel::domain::AttributeName, AttributeValue> {
        ...
        attrs.insert(kernel::domain::AttributeName::new("name").unwrap(), AttributeValue::string(&self.name));
        attrs.insert(kernel::domain::AttributeName::new("active").unwrap(), AttributeValue::bool(self.active));
        attrs.insert(kernel::domain::AttributeName::new("role").unwrap(), AttributeValue::string(&self.role));
        attrs.insert(kernel::domain::AttributeName::new("department").unwrap(), AttributeValue::string(&self.department));
        attrs
    }
}
...
impl HodeiEntityType for MockDocument {
    ...
    fn attributes_schema() -> Vec<(kernel::domain::AttributeName, kernel::domain::AttributeType)> {
        vec![
            (kernel::domain::AttributeName::new("title").unwrap(), kernel::domain::AttributeType::string()),
            (kernel::domain::AttributeName::new("classification").unwrap(), kernel::domain::AttributeType::string()),
            (kernel::domain::AttributeName::new("owner").unwrap(), kernel::domain::AttributeType::string()),
        ]
    }
}
...
impl HodeiEntity for MockDocument {
    ...
    fn attributes(&self) -> HashMap<kernel::domain::AttributeName, AttributeValue> {
        let mut attrs = HashMap::new();
        attrs.insert(kernel::domain::AttributeName::new("title").unwrap(), AttributeValue::string(&self.title));
        attrs.insert(kernel::domain::AttributeName::new("classification").unwrap(), AttributeValue::string(&self.classification));
        attrs.insert(kernel::domain::AttributeName::new("owner").unwrap(), AttributeValue::string(&self.owner));
        attrs
    }
}
...
impl HodeiEntityType for MockGroup {
    ...
    fn attributes_schema() -> Vec<(kernel::domain::AttributeName, kernel::domain::AttributeType)> {
        vec![
            (kernel::domain::AttributeName::new("name").unwrap(), kernel::domain::AttributeType::string()),
            (kernel::domain::AttributeName::new("members").unwrap(), kernel::domain::AttributeType::set(kernel::domain::AttributeType::string())),
        ]
    }
}
...
impl HodeiEntity for MockGroup {
    ...
    fn attributes(&self) -> HashMap<kernel::domain::AttributeName, AttributeValue> {
        let mut attrs = HashMap::new();
        attrs.insert(kernel::domain::AttributeName::new("name").unwrap(), AttributeValue::string(&self.name));
        attrs.insert(kernel::domain::AttributeName::new("members").unwrap(), AttributeValue::set(self.members.iter().map(|m| AttributeValue::string(m)).collect()));
        attrs
    }
}
...
async fn test_simple_permit_allows_access() {
    ...
    let alice = MockUser {
        hrn: Hrn::new("aws".to_string(), "iam".to_string(), "123".to_string(), "User".to_string(), "alice".to_string()),
    ...
    let doc1 = MockDocument {
        hrn: Hrn::new("aws".to_string(), "storage".to_string(), "123".to_string(), "Document".to_string(), "doc1".to_string()),
    ...
    let command = EvaluatePoliciesCommand { request, policies: &policy_set, entities: &entities };
...
async fn test_simple_forbid_denies_access() {
    ...
    let eve = MockUser {
        hrn: Hrn::new("aws".to_string(), "iam".to_string(), "123".to_string(), "User".to_string(), "eve".to_string()),
        name: "Eve".to_string(),
        active: true,
        role: "user".to_string(),
...
async fn test_policy_with_when_condition_denies() {
    ...
    let bob = MockUser {
        hrn: Hrn::new("aws".to_string(), "iam".to_string(), "123".to_string(), "User".to_string(), "bob".to_string()),
        name: "Bob".to_string(),
...
#[tokio::test]
async fn test_multiple_policies_permit_takes_precedence() {
    let use_case = EvaluatePoliciesUseCase::new();
    ...
    assert!(result.is_ok());
    let decision = result.unwrap();
    assert_eq!(decision.decision, Decision::Allow); // Permit takes precedence
}
...
async fn test_invalid_policy_syntax() {
    ...
    match result.unwrap_err() {
        EvaluatePoliciesError::TranslationError(_) => {} // Expected
...
async fn test_missing_entities() {
    ...
    let policy_set = HodeiPolicySet::new(vec![policy]);
    let entities: Vec<&dyn HodeiEntity> = vec![]; // No entities

    let request = AuthorizationRequest {
        principal_hrn: &Hrn::new("aws".to_string(), "iam".to_string(), "123".to_string(), "User".to_string(), "alice".to_string()),
        action: "Read",
        resource_hrn: &Hrn::new("aws".to_string(), "storage".to_string(), "123".to_string(), "Document".to_string(), "doc1".to_string()),
        context: None,
    };
...
async fn test_policy_with_group_membership() {
    ...
    let admins_group = MockGroup {
        hrn: Hrn::new("aws".to_string(), "iam".to_string(), "123".to_string(), "Group".to_string(), "admins".to_string()),
    ...
    let policy = HodeiPolicy::new(
        ...
        permit(
            ...
            Iam::Group::"admins".members.contains(principal.name)
        };"#.to_string(),
        None,
    );
    let policy_set = HodeiPolicySet::new(vec![policy]);
...
async fn test_policy_with_complex_context() {
    ...
    context.insert("ip_ranges".to_string(), serde_json::json!(["192.168.1.0/24"]));
...
async fn test_large_number_of_entities() {
    ...
    for i in 0..20 {
        let user = MockUser {
            hrn: Hrn::new("aws".to_string(), "iam".to_string(), "123".to_string(), "User".to_string(), format!("user-{}", i)),
            name: format!("User {}", i),
            active: true,
            role: "user".to_string(),
            department: "engineering".to_string(),
