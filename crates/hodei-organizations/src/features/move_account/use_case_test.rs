...
async fn test_move_account_with_repository_failure_rolls_back() {
    ...
    assert!(
        result.is_err(),
        "Move account should fail when repository fails"
    );
...
async fn test_move_account_account_not_found() {
    ...
    assert!(
        result.is_err(),
        "Move account should fail when account not found"
    );
...
async fn test_move_account_source_ou_not_found() {
    ...
    assert!(
        result.is_err(),
        "Move account should fail when source OU not found"
    );
...
async fn test_move_account_target_ou_not_found() {
    ...
    assert!(
        result.is_err(),
        "Move account should fail when target OU not found"
    );
