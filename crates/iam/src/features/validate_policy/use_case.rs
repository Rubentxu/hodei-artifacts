...
impl ValidatePolicyUseCase {
    ...
    pub async fn execute(&self, request: ValidatePolicyRequest) -> Result<ValidatePolicyResponse, ValidatePolicyError> {
        // Here you could add more logic, like metrics, logging, etc.
        tracing::info!("Validating policy...");

        self.validator.validate_policy(&request.policy).await
            .map_err(|e| ValidatePolicyError::validation_failed(vec![
