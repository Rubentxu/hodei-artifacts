...
mod tests {
    ...
    mock! {
        pub SbomRepository {
            ...
            async fn get_by_artifact_id(&self, artifact_id: &shared::hrn::PhysicalArtifactId) -> Result<Option<Sbom>, SbomRepositoryError> {}
        }
    }
    ...
    mock! {
        pub ArtifactRetriever {
            async fn get_physical_artifact(&self, artifact_id: &shared::hrn::PhysicalArtifactId) -> Result<artifact::domain::physical_artifact::PhysicalArtifact, SbomGenerationError> {}
        }
    }
